...
exports.execute = (client, message, args) => {
  message.delete().catch(O_o=>{}); 
      ...
      if(!logchannel) return message.channel.send("``Ce serveur n'a pas encore été setup !\nFaites la commande **-setup** pour débuter.``")
      ...
      //if(!message.member.id !== "323147880548270081") return message.reply('Je ne peux pas **BAN** ce membre ( **c\'est mon papa** :nerd:  )');
